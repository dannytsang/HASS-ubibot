...
class SensorBase(Entity):
    ...
    def device_info(self):
        ...
        return {"identifiers": {(DOMAIN, self._channel.channel_id)}}
    ...
    async def async_added_to_hass(self):
        ...
        self._channel.register_callback(self.async_write_ha_state)

    async def async_will_remove_from_hass(self):
        """Entity being removed from hass."""
        # The opposite of async_added_to_hass. Remove any registered call backs here.
        self._channel.remove_callback(self.async_write_ha_state)
...
class BatterySensor(SensorBase):
    ...
    def __init__(self, channel):
        ...
        self._attr_unique_id = f"{self._channel.channel_id}_battery"

        # The name of the entity
        self._attr_name = f"{self._channel.name} Battery"
    ...
    def state(self):
        ...
        return self._channel.battery_level
...
class IlluminanceSensor(SensorBase):
    ...
    def __init__(self, channel):
        ...
        # As per the sensor, this must be a unique value within this domain. This is done
        # by using the device ID, and appending "_battery"
        self._attr_unique_id = f"{self._channel.channel_id}_illuminance"

        # The name of the entity
        self._attr_name = f"{self._channel.name} Illuminance"

    @property
    def state(self):
        """Return the state of the sensor."""
        return self._channel.illuminance
